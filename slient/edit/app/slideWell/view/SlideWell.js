	...
	function(Backbone, multisortable, SlideSnapshot, GlobalEvents, CmdListFactory) {
		...
		return Backbone.View.extend({
			...
			render: function() {
				...
				this._addProvider = this.model.get('addProvider');
				if(this._addProvider){
					this.$el.append(this._addProvider.render());
				}
			...
			/**
			 * [_showAddSlideBtn mousermove event to change add slide button position]
			 * @param  {[document event]} e
			 */
			_showAddSlideBtn: function(e){
				if(this._addProvider){
					this._addProvider.fixtaking(e);
				}
			},
